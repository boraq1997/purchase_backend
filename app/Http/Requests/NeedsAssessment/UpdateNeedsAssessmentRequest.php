...
class UpdateNeedsAssessmentRequest extends FormRequest
{
    public function authorize(): bool
    {
        $user = auth()->user();
        return $user && $user->can('edit-NeedsAssessment');
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'needs_status'        => 'sometimes|required|in:needed,not_needed,modified',
            ...
            'assessment_state'   => 'sometimes|required|in:draft,final',
